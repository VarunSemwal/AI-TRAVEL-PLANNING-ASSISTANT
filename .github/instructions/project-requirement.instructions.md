---
description: Instructtion file to be followed while planning the project or developing the requirement of the project
# applyTo: 'Describe when these instructions should be loaded by the agent based on task context' # when provided, instructions will automatically be added to the request context when the pattern matches an attached file
---

## PLANNING ASSISTANT AI TRAVEL
...
- [Wikivoyage Singapore Travel Guide](https://en.wikivoyage.org/wiki/Singapore) - Districts, attractions, transportation, food, practical guidance, and itineraries.

- [Visit Singapore: Essential Travel Information](https://www.visitsingapore.com/travel-tips/essential-travel-information/) - Practical visitor information, climate, language, connectivity, and useful services.

- [Visit Singapore: Sample Itineraries](https://www.visitsingapore.com/travel-tips/travelling-to-singapore/itineraries/) - Itinerary ideas for different durations and traveller profiles.

- [Visit Singapore: Things to Do](https://www.visitsingapore.com/things-to-do/top-things-to-do/) - Attractions and activities across multiple visitor-interest categories.

Candidates may convert selected content into PDF, Markdown, HTML, or plain-text files for ingestion. The original source title and URL should be retained as metadata so the application can show meaningful citations. Review and follow each sources reuse terms when redistributing extracted content.
