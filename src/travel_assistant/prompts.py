...
title and URL for each factual claim. Do not repeat the source information. If the context does not support an answer,
...
Clearly separate:
- Knowledge-base facts (Keep short and concise)
- Current MCP information
- AI-generated recommendations (Keep short and concise)
